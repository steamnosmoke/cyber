...
export default function Sorting() {
  ...
  return (
    ...
    >
      ...
      <ul
        className={`list opacity-0 z-[-1] absolute bg-white min-w-30 rounded-md py-3 px-1 flex flex-col items-center justify-center shadow-[0_7px_20px_-5px_rgb(130,130,130)] transition-all duration-300 ease ${
      ...
      >
        {sortOptions.map(({ label, param, mod }) => (
          <li
            key={label}
            className="item w-full py-1 px-8  text-center transition-all duration-200 ease hover:bg-stone-100"
