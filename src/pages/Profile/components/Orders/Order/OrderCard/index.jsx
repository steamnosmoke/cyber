...
export default function OrderCard({ product }) {
  ...
  return (
    ...
    >
      <section className="grid grid-cols-[auto] grid-rows-[auto_80px_20px] justify-center gap-10 cursor-pointer relative" key={product.id}>
        ...
        <p className="price text-2xl font-semibold text-center">
          {product.count} x {Number(product.totalPrice)}$
        </p>
      </section>
    </Link>
  );
