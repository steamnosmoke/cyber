...
export default function UserData({ flag }: { flag: boolean }) {
  ...
  return (
    <section
      className={`userdata mx-auto w-full border-b-1 border-b-stone-300 flex flex-col items-center transition-all duration-200 ease ${
        flag
          ? "pb-5 max-h-200 mt-4 overflow-y-visible"
          : "pb-0 max-h-0 mt-[-1px]  overflow-y-hidden"
      }`}
    >
