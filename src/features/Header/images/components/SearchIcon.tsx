export default function SearchIcon() {
  return (
    <svg
      className="search-icon absolute w-5 h-5 left-4 z-50 top-4 group-hover:stroke-stone-700"
      width="24.000000"
      height="24.000000"
      viewBox="0 0 24 24"
      fill="none"
    ...
    >
      ...
      <g clipPath="url(#clip2603_4285)">
        <path
          className="group-hover:stroke-stone-700 transition-all duration-150"
          id="Vector"
